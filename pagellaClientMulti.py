...
def genera_richieste2(num,address,port): 
  ...
  #   1. Generazione casuale di uno studente(valori ammessi: 5 cognomi a caso scelti da una lista)
    pagella={"Mario Rossi":[("Matematica",7,0),("Italiano",7,3),("Inglese",7.5,4),("Storia",7.5,4),("Geografia",5,7)],
         "Matteo Marchesi":[("Matematica",8,0),("Italiano",7,4),("Inglese",7.5,5),("Storia",9,4),("Geografia",5,3)],
         "Nicola Marione":[("Matematica",7,4),("Italiano",9,4),("Inglese",5,8),("Storia",5,1),("Geografia",9,3)]}
